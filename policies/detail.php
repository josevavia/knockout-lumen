...
<div data-bind="with: policy">
    ...
    <p>DISTRIBUTOR: <a data-bind="attr: {href: '../distributors/detail.php?id='+store.distributor.identifier}"><span data-bind="text: store.distributor.name"></span></a></p>
    <p>STORE: <a data-bind="attr: {href: '../stores/detail.php?id='+store.identifier}"><span data-bind="text: store.name"></span></a></p>
